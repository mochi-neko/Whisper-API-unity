...
namespace Mochineko.Whisper_API.Formats
{
    ...
    public sealed class WhisperConnection
    {
        ...
        /// <param name="model">Audio model</param>
        ...
        /// <summary>
        /// Create a text though Whisper chat speech to text API.
        /// https://platform.openai.com/docs/api-reference/audio/create
        /// </summary>
        /// <param name="file">File path of speech audio</param>
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>Response from Whisper chat speech to text API.</returns>
        ...
        public async Task<APIResponseBody> CreateTextAsync(string file, CancellationToken cancellationToken)
        {
