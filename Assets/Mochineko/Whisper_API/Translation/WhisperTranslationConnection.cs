...
{
    /// <summary>
    /// Binds Whisper translation API.
    /// https://platform.openai.com/docs/api-reference/audio/create
    /// </summary>
    public sealed class WhisperTranslationConnection
    {
        ...
        public WhisperTranslationConnection(string apiKey, Model model = Model.Whisper1)
        {
        ...
        /// <exception cref="ArgumentNullException">API Key must be set</exception>
        public WhisperTranslationConnection(string apiKey, APIRequestBody requestBody)
        {
            if (string.IsNullOrEmpty(apiKey))
            {
                throw new ArgumentNullException(nameof(apiKey));
