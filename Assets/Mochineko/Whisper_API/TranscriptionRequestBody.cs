...
namespace Mochineko.Whisper_API
{
    ...
    /// </summary>
    [JsonObject]
    public sealed class TranscriptionRequestBody
    {
        /// <summary>
        /// [Required]
        ...
        public static TranscriptionRequestBody? FromJson(string json)
            => JsonConvert.DeserializeObject<TranscriptionRequestBody>(json);
    }
}